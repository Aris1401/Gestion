 ...
 * @author aris
 */
@WebServlet(name = "DejaPostuler", urlPatterns = {"/DejaPostuler"})
public class DejaPostuler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("user") != null) {
            ...
            try {
                ResponsePrinter.PrintToJSON(response, model.CV.dejaPostulter(user.getPersonneInformation().getId(), besoin));
            } catch (Exception ex) {
